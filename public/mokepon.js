...
let hipodoge = new Mokepon(
  "Hipodoge",
  "./asset/mokepons_mokepon_hipodoge_attack.webp",
  5,
  "Agua"
);
let capipepo = new Mokepon(
  "Capipepo",
  "./asset/mokepons_mokepon_capipepo_attack.webp",
  5,
  "Tierra"
);
let ratigueya = new Mokepon(
  "Ratigueya",
  "./asset/mokepons_mokepon_ratigueya_attack.webp",
  5,
  "Fuego"
);
let langostelvis = new Mokepon(
  "Langostelvis",
  "./asset/mokepons_mokepon_langostelvis_attack.png",
  5,
  "Fuego"
);
let tucapalma = new Mokepon(
  "Tucapalma",
  "./asset/mokepons_mokepon_tucapalma_attack.png",
  5,
  "Tierra"
);
let pydos = new Mokepon(
  "Pydos",
  "./asset/mokepons_mokepon_pydos_attack.png",
  5,
  "Agua"
);
...
function iniciarJuego() {
  let contenedorTarjetas = document.getElementById("contenedor-de-tarjetas");
...
function tiposAtaques() {
  /*-----------COMPARA CUANDO FUEGO ES MAYOR QUE TIERRA-----------*/
  if (tipoAtaqueJugador === "Fuego" && tipoAtaqueEnemigo === "Tierra") {
    ...
    /*-----------COMPARA CUANDO TIERRA ES MAYOR QUE AGUA-----------*/
    ataquesGuardadosJugador.push({
      nombre: "🌱",
      id: "boton-tierra",
      claseEstilos: "tierra"
    ...
    /*-----------COMPARA CUANDO AGUA ES MAYOR QUE FUEGO-----------*/
    ataquesGuardadosJugador.push({
      nombre: "💧",
      id: "boton-agua",
      claseEstilos: "agua"
...
function verificarVidas() {
  if (victoriasJugador == victoriasEnemigo) {
    crearMensajeFinal(
      "¡¡EMPATE, inténtalo de nuevo 🫂!! <p><i class='fa-solid fa-face-smile'></i></p>"
    ); //ganas
    ...
    crearMensajeFinal(
      "¡¡PERDISTE, inténtalo de nuevo ☠️!! <p class ='figuraResultado'><i class='fa-solid fa-face-sad-tear'></i></p>"
    ); //pierdes
